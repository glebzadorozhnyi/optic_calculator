...
st.markdown('Расчёт количества пикселей, которые будет занимать цель на матрице для заданной матрицы, размера цели, дальности до цели и фокуса (или углового поля) объектива.')
...
threshold_pixel_count = Focus.pixel_count_calc(focus, target_size, distance, pixel_size)
...
with col_pixels2:
    st.markdown('### ' + str(threshold_pixel_count,) + ' шт')
